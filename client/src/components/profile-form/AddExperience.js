...
const AddExperience = ({addExperience, history}) => {
    ...
    const [toDateDisabled, togggleDisabled] = useState(false)
    ...
    return (
      ...
      <form className="form" onSubmit={e=> onSubmit(e)}>
        ...
        <div className="form-group">
          <h4>To Date</h4>
          <input type="date" name="to" value={to} onChange={e=>onChange(e)} disabled= {toDateDisabled? 'disable': ''}/>
        </div>
        <div className="form-group">
          <textarea
            name="description"
...
// use withRouter when redirecting from action